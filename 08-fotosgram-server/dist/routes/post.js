...
postRoutes.post('/', [autenticacion_1.verificaToken], function (req, res) {
    ...
    post_model_1.Post.create(body)
        .then(function (postDB) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, postDB.populate('usuario', '-password').execPopulate()];
                case 1:
                    _a.sent(); // esperamos a recibir la información del usuario para continuar con la ejecución, no pass
                    res.json({
                        ok: true,
                        post: postDB
                    });
